...
public class FixtureResults {
    ...
    private ArrayList<GoalScorers> goalscorers;
    ...
    public void setGoalscorers(ArrayList<GoalScorers> goalscorers) {
    ...
    public FixtureResults(String event_key, String event_date, String event_time, String event_home_team, String home_team_key, String event_away_team, String away_team_key, String event_halftime_result, String event_final_result, String event_status, String country_name, String league_name, String league_key, String league_round, String league_season, String event_live, ArrayList<GoalScorers> goalscorers) {
        this.event_key = event_key;
        this.event_date = event_date;
        this.event_time = event_time;
        this.event_home_team = event_home_team;
    ...
    public ArrayList<GoalScorers> getGoalscorers() {
        return goalscorers;
    }
}
